...
for map in mapList:
        if map.endswith(".json"):
                ...
                for key, value in generatedMap.iteritems():
                        ...
                        for val in value:
                                #print(val['latitude'])
                                coordArr=np.array([val["latitude"],  val["longitude"]])
                ...
                #"/home/jcarlos2289/Documentos/SmartCityNuevasCalles_TagsReduced/lat=38,39253_long=-0,53743.txt"
                ...
                flName = map.replace(".json","_knn"+str(k)+".json" )
